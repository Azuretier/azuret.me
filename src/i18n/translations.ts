...
const en: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'A gamified English app with XP quests, a wordbook, speaking prompts, writing reps, and IELTS-friendly drills.',
...
const ja: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'XPクエスト、単語帳、スピーキング、ライティング、IELTS向けドリルで英語を楽しく鍛える学習アプリ。',
...
const th: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'แอปเรียนอังกฤษแบบเกม มีเควสต์ XP สมุดคำศัพท์ ฝึกพูด ฝึกเขียน และดริลล์ที่เหมาะกับ IELTS',
    hybridNotesTitle: 'Hybrid Notes Desktop',
...
const es: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'Una app gamificada para aprender ingles con misiones XP, vocabulario, speaking, writing y practica estilo IELTS.',
    hybridNotesTitle: 'Hybrid Notes Desktop',
