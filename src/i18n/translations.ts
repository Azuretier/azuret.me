...
const en: Translations = {
  ...
  projects: {
    ...
    englishDescription: 'IELTS sprint tests, Task 2 planning, speaking cues, and daily English practice.',
...
const ja: Translations = {
  ...
  projects: {
    ...
    englishTitle: '英語スタジオ',
    englishDescription: 'IELTSスプリントテスト、Task 2プラン、スピーキング練習で毎日英語を鍛えられます。',
...
const th: Translations = {
  ...
  projects: {
    ...
    englishDescription: 'ฝึก IELTS แบบสปรินต์ วางแผน Task 2 ฝึกพูด และใช้ภาษาอังกฤษทุกวัน',
    hybridNotesTitle: 'Hybrid Notes Desktop',
...
const es: Translations = {
  ...
  projects: {
    ...
    englishDescription: 'Pruebas rapidas de IELTS, planificacion de Task 2, speaking cues y practica diaria de ingles.',
    hybridNotesTitle: 'Hybrid Notes Desktop',
