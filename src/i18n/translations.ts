...
const en: Translations = {
  ...
  projects: {
    ...
    englishDescription: 'A gamified English learning app with XP quests, speaking prompts, writing reps, and IELTS-friendly drills.',
...
const ja: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'XPクエスト、スピーキング、ライティング、IELTS向けドリルで英語を楽しく鍛える学習アプリ。',
...
const th: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'แอปเรียนอังกฤษแบบเกม มีเควสต์ XP ฝึกพูด ฝึกเขียน และดริลล์ที่เหมาะกับ IELTS',
    hybridNotesTitle: 'Hybrid Notes Desktop',
...
const es: Translations = {
  ...
  projects: {
    ...
    englishTitle: 'English Quest',
    englishDescription: 'Una app gamificada para aprender ingles con misiones XP, speaking, writing y practica estilo IELTS.',
    hybridNotesTitle: 'Hybrid Notes Desktop',
