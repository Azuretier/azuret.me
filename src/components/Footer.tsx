    ...
    <footer className="relative border-t border-border-subtle py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-semibold text-text-primary mb-4">Documentation</h4>
            <ul className="space-y-2">
              {['Getting Started', 'Core Concepts', 'Features', 'API Reference'].map((item) => (
                <li key={item}>
                  <a href="#docs" className="text-sm text-text-muted hover:text-text-secondary transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-sm font-semibold text-text-primary mb-4">More</h4>
            <ul className="space-y-2">
              {['About', 'Changelog', 'License', 'Privacy'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-text-muted hover:text-text-secondary transition-colors">
                    {item}
                  </a>
        ...
        <div className="pt-8 border-t border-border-subtle flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-text-muted">
            &copy; {new Date().getFullYear()} azuret.me. All rights reserved.
          </p>
